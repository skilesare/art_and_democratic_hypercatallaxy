...
**Society has found it convienent for citizens to be able to group together to form groups that have legal rights and that can collect and distribut money.  How will we handle this.**

The state has allowed its citizens to group themseleves into many differnt types of legal entities:
...
One key distinction is that although legal entity accounts will look like regular accounts, they will be different.  We would like to propose that Legal Entity accounts not have the right to private payment and dispersal.  We may want to support the exchange of funds that are undiscoverable for a timeperiod but then unlock incase there are sensative issues at hand, but those should be determined by rule of law.  Legal Entites that are not citizens should not be allowed to hide activity from the general public.  They are give protected rights and should be held accountable.
